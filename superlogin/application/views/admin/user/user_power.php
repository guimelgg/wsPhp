                    ...
                    <form method="post" action="<?php echo base_url('admin/user/add_power') ?>" class="form-horizontal" novalidate>
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-5">Privilegio Id <span class="text-danger">*</span></label>
                                        <div class="col-md-7 controls">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Actualizar privilegio de usuario</h4>
        ...
        <form method="post" action="<?php echo base_url('admin/user/update_power') ?>" class="form-horizontal" novalidate>
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group row">
                            <label class="control-label text-right col-md-5">Privilegio <span class="text-danger"></span></label>
                            <div class="col-md-7 controls">
