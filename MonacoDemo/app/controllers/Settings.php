...
class Settings extends MY_Controller
{
    ...
    function index() {
        ...
        if ($this->form_validation->run() == true) {
            ...
            $data = array(
                'site_name' => PLUG ? 'Monaco' : $this->input->post('site_name'),
                'language' => $this->input->post('language'),
                'tel' => $this->input->post('tel'),
                'currency_prefix' => PLUG ? 'USD' : strtoupper($this->input->post('currency_prefix')),
                ...
                'dateformat' => PLUG ? 'jS F Y' : $this->input->post('dateformat'),
                'timeformat' => PLUG ? 'h:i A' : $this->input->post('timeformat'),
                'header' => $this->input->post('bill_header'),
                'footer' => $this->input->post('bill_footer'),
                'default_email' => PLUG ? 'admin@admin.com' : $this->input->post('default_email'),
                ...
                // 'java_applet' => PLUG ? '0' : $this->input->post('enable_java_applet'),
                ...
                'remote_printing' => PLUG ? 1 : $this->input->post('remote_printing'),
