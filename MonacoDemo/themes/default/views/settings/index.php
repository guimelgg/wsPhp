                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span class="help-block ppp">Puedes comprar <a href="#" target="_blank">PHP POS Print Server (Windows Installer)</a>.</span>
                                        <?php if (PLUG) { ?>
                                        <span class="help-block">En la demo solo puede probar la impresión web</span>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
