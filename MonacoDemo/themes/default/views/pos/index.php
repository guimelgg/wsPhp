                ...
                <ul class="nav navbar-nav pull-left">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="<?= site_url(); ?>"><i class="fa fa-dashboard" data-toggle="tooltip" data-placement="bottom" title="<?= lang('dashboard'); ?>"></i></a></li>
                            <?php if ($Admin) { ?>
                            <li><a href="<?= site_url('settings'); ?>"  data-toggle="tooltip" data-placement="bottom" title="<?= lang('settings'); ?>"><i class="fa fa-cogs"></i></a></li>
                            <?php } ?>
                            <?php if ($this->db->dbdriver != 'sqlite3') { ?>
                            <li><a href="<?= site_url('pos/view_bill'); ?>" target="_blank"><i class="fa fa-desktop" data-placement="bottom" data-toggle="tooltip" title="<?= lang('view_bill'); ?>"></i></a></li>
                            <?php } ?>
                            <li class="hidden-xs hidden-sm"><a href="<?= site_url('pos/shortcuts'); ?>" data-toggle="ajax" ><i class="fa fa-key" data-toggle="tooltip" data-placement="bottom" title="<?= lang('shortcut_keys'); ?>"></i></a></li>
                            ...
                            <li>
                                <a href="#" data-toggle="control-sidebar" class="sidebar-icon"><i class="fa fa-folder sidebar-icon" data-toggle="tooltip" data-placement="bottom" title="<?= lang('category'); ?>"></i></a>
                            </li>
                        </ul>
                    </div>
                </nav>
                    ...
                    <tr>
                        <td style="width: 460px;">
                            ...
                            <div id="pos">
                                ...
                                <div class="well-two well-sm" id="leftdiv">
